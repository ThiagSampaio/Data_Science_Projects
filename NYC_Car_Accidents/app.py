...
"/Users/thiag/Desktop/Data_Science_Projects/NYC_CAR_Accidents/Motor_Vehicle_Collisions_-_Crashes.csv"
)
...
st.subheader("Breakdown by minute betwen %i:00 and %i:00" %(hour,(hour+1) %24))
filtered = data[
